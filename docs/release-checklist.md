...
4. If `terminal-notifier` is installed, confirm macOS notifications are enabled for `terminal-notifier`, set `CODEX_ALARM_ACTIVATE_BUNDLE_ID`, and confirm clicking the notification focuses the terminal or Codex window.
